...
directory_path = r'C:\Users\Stylianos\OneDrive - Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης\My Files\PhD\Projects\Grip game Paper 1\Pilot Study 10\Data\Strength data\Young.12'
...
time_of_adaptation_down_T1 = lb.adaptation_time_using_sd(Pert_down_T1, 250, 2, 100, 38, 100, 500, 'Example of Perturbation', 20,  plot=True)
time_of_adaptation_down_T2 = lb.adaptation_time_using_sd(Pert_down_T2, 250, 2, 100, 38, 100, 500, 'Example of Perturbation', 20, plot=True)
time_of_adaptation_up_T1 = lb.adaptation_time_using_sd(Pert_up_T1, 250, 2, 100, 38, 100, 500, 'Example of Perturbation', 20, plot=True)
time_of_adaptation_up_T2 = lb.adaptation_time_using_sd(Pert_up_T2, 250, 2, 100, 38, 100, 500, 'Example of Perturbation', 20, plot=True)
