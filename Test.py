...
data_40perc_1,data_40perc_2,data_40perc_3 = lb.read_kinvent(r'C:\Users\Stylianos\OneDrive - Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης\My Files\PhD\Projects\Grip game\Pilot Study 6\Data\Stylianos 30-9-4024\Raw data\Isometric_40%.csv')
...
data_60perc_1,data_60perc_2,data_60perc_3 = lb.read_kinvent(r'C:\Users\Stylianos\OneDrive - Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης\My Files\PhD\Projects\Grip game\Pilot Study 6\Data\Stylianos 30-9-6024\Raw data\Isometric_60%.csv')
...
data_80perc_1,data_80perc_2,data_80perc_3 = lb.read_kinvent(r'C:\Users\Stylianos\OneDrive - Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης\My Files\PhD\Projects\Grip game\Pilot Study 6\Data\Stylianos 30-9-8024\Raw data\Isometric_80%.csv')
