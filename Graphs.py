...
SaEn_Adaptation_down_min_old = Resuls_all[Resuls_all['ID_group'] == 'Old']['SaEn_Adaptation_down_min_list'].to_numpy()
SaEn_Adaptation_down_max_old = Resuls_all[Resuls_all['ID_group'] == 'Old']['SaEn_Adaptation_down_max_list'].to_numpy()
SaEn_Adaptation_down_T1_old = Resuls_all[Resuls_all['ID_group'] == 'Old']['SaEn_Adaptation_down_T1_list'].to_numpy()
SaEn_Adaptation_down_T2_old = Resuls_all[Resuls_all['ID_group'] == 'Old']['SaEn_Adaptation_down_T2_list'].to_numpy()
SaEn_Adaptation_up_min_old = Resuls_all[Resuls_all['ID_group'] == 'Old']['SaEn_Adaptation_up_min_list'].to_numpy()
SaEn_Adaptation_up_max_old = Resuls_all[Resuls_all['ID_group'] == 'Old']['SaEn_Adaptation_up_max_list'].to_numpy()
SaEn_Adaptation_up_T1_old = Resuls_all[Resuls_all['ID_group'] == 'Old']['SaEn_Adaptation_up_T1_list'].to_numpy()
SaEn_Adaptation_up_T2_old = Resuls_all[Resuls_all['ID_group'] == 'Old']['SaEn_Adaptation_up_T2_list'].to_numpy()
...
SaEn_Adaptation_down_min_Young = Resuls_all[Resuls_all['ID_group'] == 'Young']['SaEn_Adaptation_down_min_list'].to_numpy()
SaEn_Adaptation_down_max_Young = Resuls_all[Resuls_all['ID_group'] == 'Young']['SaEn_Adaptation_down_max_list'].to_numpy()
SaEn_Adaptation_down_T1_Young = Resuls_all[Resuls_all['ID_group'] == 'Young']['SaEn_Adaptation_down_T1_list'].to_numpy()
SaEn_Adaptation_down_T2_Young = Resuls_all[Resuls_all['ID_group'] == 'Young']['SaEn_Adaptation_down_T2_list'].to_numpy()
SaEn_Adaptation_up_min_Young = Resuls_all[Resuls_all['ID_group'] == 'Young']['SaEn_Adaptation_up_min_list'].to_numpy()
SaEn_Adaptation_up_max_Young = Resuls_all[Resuls_all['ID_group'] == 'Young']['SaEn_Adaptation_up_max_list'].to_numpy()
SaEn_Adaptation_up_T1_Young = Resuls_all[Resuls_all['ID_group'] == 'Young']['SaEn_Adaptation_up_T1_list'].to_numpy()
SaEn_Adaptation_up_T2_Young = Resuls_all[Resuls_all['ID_group'] == 'Young']['SaEn_Adaptation_up_T2_list'].to_numpy()
